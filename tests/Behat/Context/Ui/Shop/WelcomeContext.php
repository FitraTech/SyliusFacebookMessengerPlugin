...
namespace Tests\FitraTech\SyliusFacebookMessengerPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\FitraTech\SyliusFacebookMessengerPlugin\Behat\Page\Shop\WelcomePageInterface;
